**Disclaimer**: we didn't solve any of these tasks during the CTF proper but were persistent enough to solve them afterwards. *Huge* thanks to the organizers for making it possible:
